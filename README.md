...
running command...
$ pg-tools (--version)
@alexvyber/pg-tools/0.0.0-dev.6 darwin-arm64 node-v24.7.0
...
_See code: [src/commands/create.ts](https://github.com/alexvyber/pg-tools/blob/v0.0.0-dev.6/src/commands/create.ts)_
...
_See code: [src/commands/drop.ts](https://github.com/alexvyber/pg-tools/blob/v0.0.0-dev.6/src/commands/drop.ts)_
<!-- commandsstop -->
